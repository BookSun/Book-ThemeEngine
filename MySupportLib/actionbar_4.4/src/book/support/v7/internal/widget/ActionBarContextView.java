...
import book.support.v7.app.ActionBarImplBase.ActionModeImpl;
...
//        	abcv.setBackgroundColor(0xff0000ff);
        ...
        static void addActionModeOptionMenu(final ActionBarContextView abcv,
            ...
            if (abcv.mSplitView instanceof bookActionBarContainer) {
                ...
                ((bookActionBarContainer) abcv.mSplitView).getActionModeMenuBar().addView(abcv.mMenuView, layoutParams);
