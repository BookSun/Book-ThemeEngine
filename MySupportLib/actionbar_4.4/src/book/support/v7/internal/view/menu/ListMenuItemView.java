...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public void setItemColor(int color) {
        // ColorStateList colorList = mTitleView.getTextColors();
        // if (colorList != null) {
        //     int[] colors = colorList.getColors();
        //     // Reset default color.
        //     colorList.setColor(colors.length - 1, color);

        //     if (mTitleView != null) {
        //         mTitleView.setTextColor(colorList);
        //     }

        //     if (mShortcutView != null) {
        //         mShortcutView.setTextColor(colorList);
        //     }
        // }
        ...
        if (mShortcutView != null) {
            mShortcutView.setTextColor(color);
        }
    }
    // book ADD END
}
