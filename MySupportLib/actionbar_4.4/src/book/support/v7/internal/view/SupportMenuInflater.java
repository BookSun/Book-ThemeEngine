...
public class SupportMenuInflater extends MenuInflater {
    ...
    static class Injector {
        static void initbookMenuStyle(SupportMenuInflater oThis) {
            oThis.mMenuStyle = Settings.System.getInt(oThis.mContext.getContentResolver(), ActionBar.book_ACTION_MENU_STYLE, 
        ...
        static int getbookShowAsActionStyle(final SupportMenuInflater oThis, final int showAsAction) {
            ...
            if (oThis.mMenuStyle == 0) {
                if ((showAsAction & MenuItem.SHOW_AS_ACTION_WITH_TEXT) != 0) { // no 
                    newStyle ^= MenuItem.SHOW_AS_ACTION_WITH_TEXT;
                }
            } else if (oThis.mMenuStyle == 1) {
                if ((showAsAction & MenuItem.SHOW_AS_ACTION_WITH_TEXT) == 0) { // no atrr add 
                    newStyle |= MenuItem.SHOW_AS_ACTION_WITH_TEXT;
                }
            }
