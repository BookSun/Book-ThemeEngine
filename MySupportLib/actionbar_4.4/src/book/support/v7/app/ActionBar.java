 ...
 * ActionBarActivity#getSupportActionBar}.</p>
 *
 * <p>In some cases, the action bar may be overlayed by another bar that enables contextual actions,
 * using an {@link book.support.v7.view.ActionMode}. For example, when the user selects one or
 ...
 * the same space, the {@link book.support.v7.view.ActionMode} APIs are distinct and independent
...
public abstract class ActionBar {
	...
	public static final String book_ACTION_MENU_STYLE = "book_action_menu_style";
	public static final int book_ACTION_MENU_STYLE_ICON  = 0;
	public static final int book_ACTION_MENU_STYLE_ICON_WITH_TEXT = 1;
    /**
...
///book  BEGIN
    ...
    public abstract void smoothScrollTabIndicator(int position, float positionOffset, int positionOffsetPixels);
...
///book BEGIN
	/**
     * Indicator the tab which has secondary tab
     *
     * @param index indicator which tab has secondary tab
     * @hide
     */
	//@bookHook(bookHook.bookHookType.NEW_METHOD)
	public abstract void setHasSecondaryTab(int index);
...
///book BEGIN
   /**
     * add by book Shenqi
     * Retrieve the current height of the Split view of ActionBar.
     *
     * @return The Split view of Actionbar's height
     */
    public abstract int getSplitHeight();
///book END
    /**
...
///book BEGIN
	/**
	* add by book Shenqi
	* Show the ActionBar split view if it is not currently showing.
	* If the window hosting the ActionBar does not have the feature
	* {@link Window#FEATURE_ACTION_BAR_OVERLAY} it will resize application
	* content to fit the new space available.
	*/
	public abstract void showSplit();
///book END
    /**
...
///book BEGIN
	/**
     * add by book Shenqi
     * Hide the ActionBar Split view if it is currently showing.
     * If the window hosting the ActionBar does not have the feature
     * {@link Window#FEATURE_ACTION_BAR_OVERLAY} it will resize application
     * content to fit the new space available.
     */
    public abstract void hideSplit();
   /**
     * add by book Shenqi
     * Hide the ActionBar Split view with no Animation if it is currently showing.
     * If the window hosting the ActionBar does not have the feature
     * {@link Window#FEATURE_ACTION_BAR_OVERLAY} it will resize application
     * content to fit the new space available.
     */
	public abstract void hideSplitNoAnimation();

    public abstract boolean isSplitVisible();

    public abstract boolean isActionOptionMenuVisible();
///book END
    /**
...
///book BEGIN
        /**
         * Set the custom view width of the custom view set by using setCustomView
         *
         * @param width The width to be set
         * @return void
         */
		public abstract void setCustomViewWidth(int width);

        /**
         * Get the custom view width of the custom view set by using setCustomView
         *
         * @param void
         * @return The value of the width
         */
		public abstract int getCustomViewWidth();

        /**
         * Set to hide the indicator view or not
         *
         * @param hide The indicator view or not 
         * @return void
         */
		public abstract void setHideIndicator(boolean hide);

        /**
         * Judge the indicator view to be hide or not
         *
         * @param null
