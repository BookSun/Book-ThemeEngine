...
public class ActionBarActivity extends FragmentActivity implements ActionBar.Callback,
    ...
    public  boolean onMenuItemSelected(int featureId, android.view.MenuItem item) {
        if (getDelegate().onMenuItemSelected(featureId, item)) {
            return true;
        }
    ...
    //modify for PR965109 xlgu@booktek.com begin
    @Override
    ...
    //modify for PR965109 xlgu@booktek.com end
    /**
