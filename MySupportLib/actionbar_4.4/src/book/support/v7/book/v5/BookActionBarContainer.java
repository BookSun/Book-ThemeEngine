...
public class bookActionBarContainer extends ActionBarContainer {
    private static final boolean DBG = true;
    private static final String TAG = "bookActionBarContainer";
    ...
    private int mNonActionModeItemsSize;
    ...
    public bookActionBarContainer(Context context) {
        this(context, null);
    }

    public bookActionBarContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initLayout(Context context) {
        ...
        ViewGroup menuView = (ViewGroup) inflater.inflate(R.layout.book_action_menubar, this, true);
        ...
        mActionRootView.setBackgroundColor(0xffffffff);
        mLlActionMenuBar.setBackgroundColor(0xffffffff);
        mLlActionOptionMenuBar.setBackgroundColor(0xffffffff);

        // Init action menu in action mode
        ViewGroup optionalMenuView = (ViewGroup) inflater.inflate(R.layout.book_actionmode_menubar, this, true);
        ...
        mActionModeRootView.setBackgroundColor(Color.GRAY);
//        mLlActionModeOptionMenuBar.setBackgroundColor(Color.GRAY);
        mLlActionModeOptionMenuBar.setBackgroundResource(R.drawable.split_action_bar_action_menu_background);
    ...
    public void setActionOptionMenuVisibility(final boolean show, boolean enableAnim, final long animTime) {
        if (mLlActionOptionMenuBar == null) {
          return;
        }
        ...
        if (show) {
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationStart(Animator animation) {
                    mIsAnimating = true;
                    setMaskVisibility(show, false, animTime);
                }

                @Override
                public void onAnimationEnd(Animator animation) {
                    mActionRootView.setTranslationY(0);
                    setActionOptionMenuVisibility(show, false, animTime);
    ...
    public void setActionModeOptionMenuVisibility(final boolean show, boolean enableAnim) {
        ...
        ValueAnimator anim = null;
        int translationY = (mActionOptionMenuItemHeight * mNonActionModeItemsSize) + (2 * (mNonActionModeItemsSize - 1));
        if (show) {
    ...
    private void setMaskVisibility(final boolean show, final boolean isActionMode, long animTime) {
    ...
    private boolean isNeedSetVisibility(LinearLayout layout, boolean show) {
        ...
        if (layout.getId() == R.id.ll_action_option_menubar) {
        if (mNonActionItemsSize <= 0) {
            return false;
        }
        }

        if (layout.getId() == R.id.ll_actionmode_option_menubar) {
            if (mNonActionModeItemsSize <= 0) {
                return false;
            }
        }
    ...
    public void setNonActionModeItemsSize(int size) {
        mNonActionModeItemsSize = size;
    }
    ...
    private int getScrollY(int animationValue, boolean isActionMode) {
        ...
        if (isActionMode) {
            translationY = (mActionOptionMenuItemHeight * mNonActionModeItemsSize);
        }
        if (isActionMode) {
