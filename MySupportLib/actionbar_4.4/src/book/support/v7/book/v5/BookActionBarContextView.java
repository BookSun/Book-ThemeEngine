...
public class bookActionBarContextView extends ActionBarContextView{
    ...
    public bookActionBarContextView(Context context) {
        this(context, null);
    }
    
    public bookActionBarContextView(Context context, AttributeSet attrs) {
        super(context, attrs);

        mRightButtonMenuItem = new ActionMenuItem(context, 0, R.id.action_mode_right_button, 0, 0, null);
    }
    
    public bookActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        mRightButtonMenuItem = new ActionMenuItem(context, 0, R.id.action_mode_right_button, 0, 0, null);
    }
    
    public boolean bookInitTitle() {
