...
public class bookActionMenuView extends ActionMenuView {
    ...
    public bookActionMenuView(Context context) {
        this(context, null);
    }

    public bookActionMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //if(childCount > 1)
        {
            ...
            int menuStyle = System.getInt(mContext.getContentResolver(),
                    ActionBar.book_ACTION_MENU_STYLE,
     ...
     */
    static void measureChildForCells(View child, int parentHeightMeasureSpec, int parentHeightPadding) {
        final LayoutParams lp = (LayoutParams) child.getLayoutParams();
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (startLeft <= 0) {
                    if (hasOverflowButton) {
                        startLeft = (int) ((right - ((childCount - 1) * width)) - (mItemMargin * (childCount - 1 - 1))) / 2;
                    } else {
                        startLeft = (int) ((right - (childCount * width)) - (mItemMargin * (childCount - 1))) / 2;
                    }
                }
