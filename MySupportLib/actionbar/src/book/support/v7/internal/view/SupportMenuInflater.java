...
import book.support.v7.internal.view.menu.MenuItemWrapperICS;
...
public class SupportMenuInflater extends MenuInflater {
    ...
    public SupportMenuInflater(Context context) {
        ...
        // book ADD BEGIN
        if (true) {
            Injector.initbookMenuStyle(this);
        }
        // book ADD END
        mContext = context;
    ...
    private class MenuState {
        ...
        // item flag add by Fan.Yang, define show in the bookActionBarContextView or not
        private boolean isbookContextView;
        ...
        public void readItem(AttributeSet attrs) {
            ...
            // book ADD BEGIN
            if (true) {
                itemShowAsAction = Injector.getbookShowAsActionStyle(SupportMenuInflater.this, itemShowAsAction);
            }
            // book ADD END
            ...
            itemAdded = false;
            TypedArray b = mContext.obtainStyledAttributes(attrs, R.styleable.bookContextView);
            isbookContextView = b.getBoolean(R.styleable.bookContextView_contextView,false);
            b.recycle();
        }
    ...
    static class Injector {
        static void initbookMenuStyle(SupportMenuInflater oThis) {
            oThis.mMenuStyle = 1;
            		//System.getInt(oThis.mContext.getContentResolver(), Settings.book_ACTION_MENU_STYLE, 
                    //Settings.book_ACTION_MENU_STYLE_ICON);
        }

        static int getbookShowAsActionStyle(final SupportMenuInflater oThis, final int showAsAction) {
            if (showAsAction == -1) {
                return showAsAction;
            }
