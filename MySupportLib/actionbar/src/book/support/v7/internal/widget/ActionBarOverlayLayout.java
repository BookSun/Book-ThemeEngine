...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
	...
	private bookActionBarContainer mActionBarBottom;
	///book END
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //if (mActionBarBottom != null && mToolBarBottom != null) {
...
//        }
    ...
    void pullChildren() {
        if (mContent == null) {
            ...
            mActionBarBottom = (bookActionBarContainer) findViewById(R.id.split_action_bar);
        }
    }
