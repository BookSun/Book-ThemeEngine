...
package book.support.v7.widget;
...
import book.support.v7.internal.transition.ActionBarTransition;
import book.support.v7.internal.view.ActionBarPolicy;
import book.support.v7.internal.view.menu.ActionMenuItemView;
import book.support.v7.internal.view.menu.BaseMenuPresenter;
...
import book.support.v7.internal.widget.TintImageView;
///book BEGIN
        ...
        static void initActionMenuItem(ActionMenuPresenter oThis, MenuItemImpl item, MenuView.ItemView itemView) {
            if (true) {
                if (oThis instanceof bookActionMenuPresenter) {
                    bookActionMenuPresenter menuPresenter = (bookActionMenuPresenter) oThis;
