package com.book.support.provider;
    ...
    public static final class System {
       ...
       /**
        ...
        public static final long FAST_MODE_DEFAULT =
                book.os.Build.book_DIAL_FASTMODE_SUPPORT ? FAST_MODE_ENABLE : FAST_MODE_DISABLE; // book modify
        ...
        /**
         * 0 is first time start book rom,1 is not the first time start book rom
         *
         */
        ...
        //Begin for incallstyle changed ,by yljiang@booktek.com 2013-12-13
        /**
         * 0 is not change, 1 is changed
         * @hide
         */
       ...
       /**
         ...
         * @hide
         */
        public static final int CALL_BREATHING_LIGHT_COLOR_DEFAULT = Resources.getSystem().getColor(book.R.color.android_config_defaultNotificationColor);
         ...
         * @hide
         */
        public static final int CALL_BREATHING_LIGHT_FREQ_DEFAULT = 0; // NingYi For Launcher // Resources.getSystem().getInteger(book.R.integer.config_defaultNotificationLedFreq);
...
///ADD BEGIN by wsliu@booktek.com for sensorprovider
        /**
...
///ADD END
       ...
       /*
        * Add for book app lock
        * @hide
        */
        public static final String book_APPLOCK_ENABLED = "book_applock_enabled";
    ...
    public static final class Secure {
        ...
        public static boolean showMagnifierWhenInput(Context context) {
            return (Build.SHOW_MAGNIFIER_WHEN_INPUT || context.getResources().getBoolean(book.R.bool.enable_magnifier_when_input)) && 
        ...
        * @hide
        */
        public static final String book_UPLOAD_DEBUG_LOG = "book_upload_debug_log";
         ...
         * @hide
         */
        public static final String bookLOCKSCREEN_INUSE = "book_lockscreen_inuse";
