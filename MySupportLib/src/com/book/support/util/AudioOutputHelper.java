...
import static com.book.support.util.Process.UID_SYSTEM;
...
//                    activityManager.getRunningAppProcesses(), context, true);
...
//    }
    ...
    public static boolean hasActiveReceivers(Context context) {
        ...
        try {
            ...
            if(BINDER_bookMUSIC) {
                processes = getbookMusicRunningProcess(runningAppProcessInfos);
            } 
//            else {
...
//            }
    ...
    private static final boolean BINDER_bookMUSIC = true ;

    private static final  String book_PLAYER [] = {"com.book.player"};

    private static List<RunningAppProcessInfo>  getbookMusicRunningProcess (List<RunningAppProcessInfo> procs){
        ArrayList<RunningAppProcessInfo> actives = new ArrayList<RunningAppProcessInfo>();
        for(RunningAppProcessInfo info :procs) {
            for(String packageName:book_PLAYER){
