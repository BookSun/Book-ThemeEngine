...
import com.book.support.graphics.BitmapInfo;
import com.book.support.graphics.IBitmapFilter;
import com.book.support.util.Constants;
import com.book.support.util.FileUtilities;
import com.book.support.util.ImageUtils;
import com.book.support.util.Shell;
//import libcore.io.Libcore;


import static com.book.support.util.Process.IS_SYSTEM;
import static com.book.support.util.Process.PACKAGE_NAME;
...
public class IconCustomizer {
    ...
    public static float mIconScale = Constants.ICON_SCALE;
    // it is a raw value without scaling by 0.884
    public static float mRawIconScale = 1.0f;
    // End

    public static int sCustomizedIconWidth = Constants.CUSTOM_ICON_WIDTH; //Resources.getSystem().getDimensionPixelSize(book.R.dimen.custom_icon_size);
    ...
    static {
        ...
        if (Shell.sLoaded) {
            Log.d("Shell", "static CUSTOMIZED_ICON_PATH : "+CUSTOMIZED_ICON_PATH);
    ...
    public static void checkModIcons() {
        try {
            File iconsFile = new File(ThemeConstants.CONFIG_ICONS_CUSTOM_PATH);
            File face = new File("/data/system/face/icons");
            if (face.exists()) {
                Log.d(LOG_TAG, "iconsFile exist");
...
//            Shell.chmod(CUSTOMIZED_ICON_STAMP, 0777);
    ...
    private static BitmapDrawable getCustomizedIcon(Context context, String packageName,
        ...
        Log.e("wangliqiang","packageName : "+packageName+"  classname : "+className);
    ...
    private static Bitmap getModIcon(String fileName) {
        ...
        if (sContext != null) {
            InputStream is = null;
            try {
                Log.e("wangliqiang","get icon from mod : "+fileName);
