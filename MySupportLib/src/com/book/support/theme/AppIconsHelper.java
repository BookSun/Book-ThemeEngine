...
import com.book.support.laml.RenderThread;
import com.book.support.laml.util.RendererCoreCache;
import com.book.support.laml.util.RendererCoreCache.RendererCoreInfo;
...
public class AppIconsHelper {
    ...
    private static void checkVersion(Context context) {
        int version = SystemProperties.getInt("sys.book.themeChanged", -1);
