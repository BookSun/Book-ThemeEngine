package com.book.support.graphics.drawable;
...
import com.book.support.graphics.Snapshot;
...
public class SnapshotDrawable extends Drawable implements Runnable, Animatable {
     ...
     *
     * @see book.graphics.Snapshot#snapshotScreen(int, int)
     */
     ...
     *
     * @see book.graphics.Snapshot#snapshotView(android.view.View)
     */
    ...
    /**
     * @see book.graphics.Snapshot#setSampleSize(int)
     */
