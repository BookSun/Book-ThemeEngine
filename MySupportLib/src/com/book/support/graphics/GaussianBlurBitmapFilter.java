package com.book.support.graphics;
...
public class GaussianBlurBitmapFilter extends BitmapFilter
{
     ...
     * It's suggested to use {@link book.graphics.BitmapFilterFactory} to create a BitmapFilter not this method.
     *
     * @see book.graphics.BitmapFilterFactory
     */
    ...
    static {
        System.loadLibrary("book_runtime");
    }
    */
}
