package com.book.themechooser.newmechanism;
 ...
 * Globals.java:
 *
 * @author yljiang@booktek.com 2013-12-2
 */
public class Globals {
    ...
    public static final String SD_THEME_RES = ThemeConstants.book_THEME_PATH + "/res";
