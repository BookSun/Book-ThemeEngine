...
public class ThemeInfoActivity extends ActionBarActivity {
    ...
    private void initList() {
        ...
        if (!ThemeManager.STANDALONE && mThemeItem.getLockscreenUri() != null || mThemeItem.getPackageName().equals("com.book.theme.bookDefaultTheme")) {
            mNameList.add(getString(R.string.lockscreen_style));
            if (mThemeItem.getPackageName().equals("com.book.theme.bookDefaultTheme")) {
                mUriList.add(Uri.parse("com.book.theme.bookDefaultTheme"));
            } else {
        ...
        if (mThemeItem.getIconsUri() != null || mThemeItem.getPackageName().equals("com.book.theme.bookDefaultTheme")) {
        ...
        if (mThemeItem.getFontUril() != null || mThemeItem.getPackageName().equals("com.book.theme.bookDefaultTheme")) {
    ...
    private void applyThemeInternal(ThemeItem appliedTheme) {
        ...
        if (icon_uri != null) {
            if (mThemeItem.getPackageName().equals("com.book.theme.bookDefaultTheme") && mThemeItem.getThemeId().equals("bookDefaultTheme")) {
        ...
        if (font_uri != null) {
            if (font_uri.toString().equals(Uri.parse("com.book.theme.bookDefaultTheme").toString())) {
        ...
        if (lockscreen_uri != null) {
            if (lockscreen_uri.toString().equals(Uri.parse("com.book.theme.bookDefaultTheme").toString())) {
