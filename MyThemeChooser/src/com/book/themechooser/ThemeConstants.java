...
public interface ThemeConstants {
    ...
    public static final String URL = "http://static.booktek.com/theme";
    ...
    public static final String THEME_PATH = "/book/theme/lwt/";
    public static final String WALLPAPER_PATH = "/book/theme/deskwallpaper/";
    public static final String LOCKWALLPAPER_PATH = "/book/theme/lockwallpaper/";
    public static final String SDCARD_ROOT_PATH = Environment.getExternalStorageDirectory().getPath();

    public static final String book_PATH = SDCARD_ROOT_PATH + "/book";

    public static final String book_THEME_PATH = book_PATH + "/theme";

    public static final String THEME_LWT = book_THEME_PATH + "/lwt";

    public static final String THEME_WALLPAPER = book_THEME_PATH + "/deskwallpaper";

    public static final String THEME_LOCK_SCREEN_WALLPAPER = book_THEME_PATH + "/lockwallpaper";

    public static final String THEME_ICONS = book_THEME_PATH + "/icons";

    public static final String THEME_PREVIEW = book_THEME_PATH + "/preview";
    
    public static final String THEME_NEW_WALLPAPER = book_THEME_PATH + "/wallpaper";
    ...
    public static final String THEME_THUMBNAIL = book_THEME_PATH + "/thumbnail";
    ...
    public static final String THEME_RINGTONE = book_THEME_PATH + "/ringtone";

    public static final String THEME_MODEL = book_THEME_PATH + "/model";
     ...
     * 发送Intent标志
     */
    public static final String KEY_book_SEND_FLAG = "com.book.filemgr.SEND_FLAG";
    public static final int VALUE_book_SEND_FLAG = 1;
    public static final int VALUE_book_MULTY_SEND_FLAG = 2;
    ...
    public static final class GoToInvokeLWT {
        ...
        public static final String ACTION_INVOKE_LWT = "com.book.lwt.action";
        public static final String INVOKE_LWT_FILE_FIELD = "com.book.lwt.field.filepath";
        public static final String FLAG_INVOKE_LWT = "filemgr";
        public static final String FLAG_KEY_INVOKE_LWT = "from";
        public static final String ACTION_DELETE_LWT = "com.book.lwt.delete.action";
    }
