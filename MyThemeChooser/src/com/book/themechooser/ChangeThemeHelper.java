            ...
            (new Thread() {
                public void run() {
                    if (!STANDALONE) {
                        ...
                        //book modify begin 
                        //forbidden stop com.book.PIM due to sms notification disappeared after theme change
                        //am.forceStopPackage("com.book.PIM");
                        //book modify end
    ...
    private void handleThemeChangeSwitch(String message) {
        ...
        /*if (ThemeUtil.isKillProcess) {
            ...
            if (!ThemeManager.STANDALONE) {
                ...
                am.forceStopPackage("com.book.themechooser");
            }
        }
        if (ThemeManager.STANDALONE) {
