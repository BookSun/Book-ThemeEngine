...
import com.book.themechooser.custom.preview.online.OnLineLockScreenStylePreview;
...
public class OnlineLockScreenStyleAdapter extends ThumbnailOnlineAdapter {
    public OnlineLockScreenStyleAdapter(Context context, ArrayList<ThemeBase> themeBases) {
        super(context, themeBases, com.book.themechooser.ThemeStatus.THEME_TYPE_LOCK_SCREEN);
    }
