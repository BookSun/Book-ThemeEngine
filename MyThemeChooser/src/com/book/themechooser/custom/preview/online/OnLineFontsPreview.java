...
public class OnLineFontsPreview extends OnlinePreviewIcons {
    public OnLineFontsPreview() {
        super();
        mThemeType = com.book.themechooser.ThemeStatus.THEME_TYPE_FONT;
    }
    ...
    protected void applyThemeInternal(ThemeItem item) {
        if (item == null) {
            ...
            ThemeApplication.sThemeStatus.setAppliedPkgName(mThemeBean.getPackageName(), com.book.themechooser.ThemeStatus.THEME_TYPE_FONT);
        }
    }
