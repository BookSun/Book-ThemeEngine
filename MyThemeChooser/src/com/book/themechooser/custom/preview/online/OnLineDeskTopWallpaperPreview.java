        ...
        try {
            ...
            try {
                ...
                ThemeApplication.sThemeStatus.setAppliedPkgName(
                        null, com.book.themechooser.ThemeStatus.THEME_TYPE_LIVEWALLPAPER);
                Settings.System.putString(getContentResolver(), "book_wallpaper_path",mThemeBean.getWallpaperUri(this).getPath());
    ...
    protected void applyTheme() {
        ...
        if (Themes.getTheme(this, mThemeBase.getPackageName(), mThemeBase.getThemeId()) == null) {
            ...
            ThemeApplication.sThemeStatus.setAppliedThumbnail(mThemeBean.getWallpaperUri(
                    this), com.book.themechooser.ThemeStatus.THEME_TYPE_WALLPAPER);
