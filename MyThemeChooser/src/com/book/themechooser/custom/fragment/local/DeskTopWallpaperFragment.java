...
public class DeskTopWallpaperFragment extends LocalBase {
    ...
    public static final String DEFAULT_THEME_PACKAGE ="com.book.theme.bookDefaultTheme"; 
    ...
    public boolean isApplied(Uri themeUri) {
        ...
        return (ThemeApplication.sThemeStatus
                ...
                ThemeApplication.sThemeStatus.isApplied(uri
                        , uri, com.book.themechooser.ThemeStatus.THEME_TYPE_WALLPAPER));
    }
    ...
    /*
     * @Override
     * public List<String> getAdditionalThemes(com.book.themechooser.ThemeStatus status) {
