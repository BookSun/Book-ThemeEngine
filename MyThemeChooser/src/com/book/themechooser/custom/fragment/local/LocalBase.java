...
import com.book.themechooser.LocalFragment;
...
import com.book.themes.widget.ThemeAdapter;
...
public abstract class LocalBase extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private Intent getCropIntent(Uri uri, int width, int height) {
        ...
        if (uri != null) {
            ...
            //"com.book.themechooser")[0], "cropped_image");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case FROM_LOCKSCREEN:
                ...
                File f = new File(ThemeConstants.THEME_LOCK_SCREEN_WALLPAPER + "/com.book.pkg." + mName + ".jpg");
                try {
                    if (!f.exists()) {
    ...
    class SetWallpaperThread extends Thread {
        ...
        public void run() {
            try {
                ...
                Long mName = System.currentTimeMillis();
                File f = new File(ThemeConstants.THEME_WALLPAPER + "/com.book.pkg." + mName + ".jpg");
                if (!f.exists()) {
                    boolean iscreate = f.createNewFile();
                }
                ...
                Settings.System.putString(mContext.getContentResolver(),"book_wallpaper_path", f.getPath());
