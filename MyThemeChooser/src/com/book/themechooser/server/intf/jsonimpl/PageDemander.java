 ...
 */
package com.book.themechooser.server.intf.jsonimpl;

import android.util.Log;

import com.book.themechooser.pojos.ThemeBase;
import com.book.themechooser.server.intf.NetBaseParam;
import com.book.themechooser.server.intf.NetHelper;
import com.book.themechooser.server.intf.PageResolver;
...
public class PageDemander extends PageResolver {
    ...
    public List currentPage() {
        ...
        return bookServerJsonParser.parseListThemeBase(NetHelper.getNetString(
    ...
    public boolean count(Object... ifneeded) {
        ...
        this.totalCount = bookServerJsonParser.parseCount(NetHelper.getNetString(((UrlParam) ifneeded[0]).toCountUrl()));
    ...
    private List getWhole(String url) {
        ...
        return bookServerJsonParser.parseListThemeBase(NetHelper.getNetString(url)
    ...
    public List getNextPageContent(int n) {
        return bookServerJsonParser.parseListThemeBase(NetHelper.getNetString(clientResolver.url.changeString(n))
                , NetBaseParam.isPackgeResource(clientResolver.url.actualtype)
                , clientResolver.url);
    }
}
