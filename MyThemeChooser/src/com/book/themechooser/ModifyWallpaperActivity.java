...
public class ModifyWallpaperActivity extends ListActivity {
    ...
    private static final String LOCKWALLPAPER = "com.book.themechooser.custom.main.LockScreenWallpaper";
    private static final String WALLPAPER = "com.book.themechooser.custom.main.DeskTopWallpaper";
    private static final String LIVEWALLPAPER = "com.book.themechooser.custom.main.LiveWallpaper";
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (WALLPAPER.equals(className)) {
                if (ThemeApplication.sThemeStatus.getAppliedPkgName(ThemeStatus.THEME_TYPE_WALLPAPER) != null
                    ...
                    imageLoader.displayImage(Themes.getTheme(context, "com.book.theme.bookDefaultTheme", "bookDefaultTheme").getWallpaperUri(context).toString(), holder.icon);
