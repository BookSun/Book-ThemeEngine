...
public class ThemeHelper implements ThemeConstants {
    ...
    public static ArrayList<ThemeBase> getThemeBases(Context context,
                                                     int themeType, int model) {
     ...
     * @param model      模块名
     */
    public static void saveThemeBases(Context context,
                                      ArrayList<ThemeBase> themeBases, int themeType, int model) {
        ...
        try {
            if (themeType == THEME_LOCAL) {
                switch (model) {
                    case ThemeConstants.THEMEPKG:
                        fos = context.openFileOutput("LOCAL_THEME",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.ICONS:
                        fos = context.openFileOutput("LOCAL_ICONS",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LOCKSCREEN:
                        fos = context.openFileOutput("LOCAL_LOCKSCREEN",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LAUNCHER:
                        fos = context.openFileOutput("LOCAL_LAUNCHER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.WALLPAPER:
                        fos = context.openFileOutput("LOCAL_WALLPAPER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LSWALLPAPER:
                        fos = context.openFileOutput("LOCAL_LSWALLPAPER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.BOOTS:
                        fos = context.openFileOutput("LOCAL_BOOTS",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.FONTS:
                ...
                switch (model) {
                    case ThemeConstants.THEMEPKG:
                        fos = context.openFileOutput("ONLINE_THEME",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.ICONS:
                        fos = context.openFileOutput("ONLINE_ICONS",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LOCKSCREEN:
                        fos = context.openFileOutput("ONLINE_LOCKSCREEN",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LAUNCHER:
                        fos = context.openFileOutput("ONLINE_LAUNCHER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.WALLPAPER:
                        fos = context.openFileOutput("ONLINE_WALLPAPER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.LSWALLPAPER:
                        fos = context.openFileOutput("ONLINE_LSWALLPAPER",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.BOOTS:
                        fos = context.openFileOutput("ONLINE_BOOTS",
                                Context.MODE_PRIVATE);
                        break;
                    case ThemeConstants.FONTS:
                        fos = context.openFileOutput("ONLINE_FONTS",
                                Context.MODE_PRIVATE);
                        break;
                    default:
                        break;
