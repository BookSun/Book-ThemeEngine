 ...
 *
 * @author gxwu@booktek.com 2012-12-13
 */
public class HttpUtils {

    // Begin, added by yljiang@booktek.com 2013-12-13 ,new mechanism
    public static final String USEER_AGENT_PREFIX = "bookApi/1.0-2";
    // End
    public static final String CLASS_NAME_BIAGENT = "book.bi.BIAgent";
    public static final String METHOD_NAME_GET_CLIENT_ID = "getBIClientId";
    public static final String CLASS_NAME_book_BUILD = "book.os.Build";
    public static final String FIELD_NAME_book_BUILD_VERSION = "book_VERSION";
    ...
    /**
     * biclient id defined by book.bi.BIAgent.getBIClientId(Context context) method *
     */
    ...
    /**
     * book os version defined by book.os.Build.book_VERSION *
     */
    private static String bookVersion = null;
    ...
    private static boolean initbookVersion = false;
     ...
     *
     * @param context
     * @return null if not book os
     */
    public static String getBiClientId(Context context) {
        if (!initBiClientId && context != null) {
            initBiClientId = true;
            // get biclient id by book.bi.BIAgent.getBIClientId(Context context) method
            Class<?> demo = null;
            try {
    ...
    /**
     * get book version, only init once
     *
     * @return null if not book os
     */
    public static String getbookVersion() {
        if (!initbookVersion) {
            initbookVersion = true;
            // get book os version by book.os.Build.book_VERSION
            Class<?> demo = null;
            try {
                demo = Class.forName(CLASS_NAME_book_BUILD);
                Field field = demo.getField(FIELD_NAME_book_BUILD_VERSION);
                return bookVersion = (String) field.get(demo.newInstance());
            } catch (Exception e) {
                /**
    ...
    public static String getUserAgent(Context context) {
        if (!initUserAgent && context != null) {
            ...
            if (bookVersion != null && bookVersion.length() > 0) {
                s.append("; ").append(bookVersion);
            }
            s.append(") ");
            ...
            if (!initBiClientId) {
                // Removed by Fan.Yang for standalone
     ...
     * HttpResponse
     *
     * @author gxwu@booktek.com 2013-4-11
     */
