package com.book.thememanager.provider;

import com.book.thememanager.Constants;
import com.book.thememanager.utils.DatabaseUtilities;
import com.book.thememanager.utils.InnerFontUtil;
import com.book.thememanager.utils.ThemeUtilities;
...
import book.content.ExtraIntent;

import static com.book.themes.ThemeManager.STANDALONE;
import static com.book.themes.Utils.parsePackage;
...
public class ThemesProvider extends ContentProvider {
    ...
    private static final String sDefaultThemeSelection
            ...
            = ThemeColumns.THEME_ID + " = 'bookDefaultTheme'";
    ...
    public static class OpenDatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createTables(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE themeitem_map (" +
                 ...
                 // Begin, added by yljiang@booktek.com 2013-11-19
    ...
    private class VerifyInstalledThemesThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                getContext().sendBroadcast(new Intent("com.book.theme.VerifyThemesCompleted")
        ...
        private List<PackageInfo> getInstalledThemePackages() {
            ...
            if(!STANDALONE){
/*                for(PackageInfo info : android.app.bookThemeHelper.getInstalledThemePackages(getContext()))
                ...
                if (imageFiles != null) {
                    for (File imageFile : imageFiles) {
                        try {
                            ...
                            ContentValues values = new ContentValues();
                            values.put(ThemeColumns.THEME_PACKAGE,"com.book.pkg.rw" + imageName.split("\\.")[0]);
                            values.put(ThemeColumns.THEME_ID, "com.book.themeid.rw"+imageName.split("\\.")[0]);
                            values.put(ThemeColumns.NAME, "com.book.pkg.rw"+imageName);
    ...
    private Cursor queryThemes(int type, Uri uri, SQLiteDatabase db, String[] projection,
        ...
        if (type == TYPE_THEMES) {
            ...
            if (n == 3) {
                ...
                if (packageName.equals("WOODY@book")) {
