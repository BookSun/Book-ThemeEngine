...
public class NewMechanismHelp {
    ...
    public static  final String book = ThemeManager.book;
    public static  final String PROVIDER_PATH = "content://com.book.themechooser.fileprovider" ;
            ...
            if(index >0){
                ...
                if (strings.length > 0) {
                    for (String str : strings) {
                        if (str.startsWith(OTHER) ||  FRAMEWORK.equals(str) ||  book.equals(str)) {
    ...
    private static void deleteOtherPackages(Context context, ThemeItem theme) {
        ...
        if(dirFile.exists() && dirFile.isDirectory()) {
            ...
            for(File file:files) {
                ...
                if (name.startsWith(OTHER) ||  FRAMEWORK.equals(name) ||  book.equals(name) ) {
                    deleteFile(file);
                }
            }
        }
