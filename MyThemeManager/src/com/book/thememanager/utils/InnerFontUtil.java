...
import com.book.thememanager.provider.ThemesProvider;
...
public class InnerFontUtil {
    public static final String PKG_PREFIX = "com.book.font.inner.";
    ...
    private static final String CONFIG_FILE = FONT_PATH + "/book-Fonts.xml";
