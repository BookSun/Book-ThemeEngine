package com.book.thememanager.receiver;

import com.book.thememanager.Constants;
import com.book.thememanager.utils.NewMechanismHelp;
        ...
        try {
            if (intent.getBooleanExtra(ThemeManager.EXTRA_EXTENDED_THEME_CHANGE, false) ||
                ...
                case CustomType.LOCKSCREEN_WALLPAPER_TYPE:
					...
					android.os.SystemProperties.set("sys.book.themeChanged", "-100");
                    break;
                ...
                try {
                    Class<?> im = Class.forName("book.util.IconManager");
