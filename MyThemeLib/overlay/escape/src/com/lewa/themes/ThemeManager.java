...
import com.book.themes.resource.BlurWallpaperUtils;
import com.book.themes.resource.IconCustomizer;
import com.book.themes.service.IThemeService;
import com.book.themes.service.IThemeServiceCallback;
...
import book.laml.util.AppIconsHelper;
...
public class ThemeManager extends BroadcastReceiver {
     ...
     *
     * @see com.book.thememanager.provider.ThemeItem
     */
     ...
     */
    public static final String PERMISSION_CHANGE_THEME = "com.book.permission.CHANGE_THEME";
     ...
     */
    public static final String ACTION_CHANGE_THEME = "com.book.intent.action.CHANGE_THEME";
    public static final String ACTION_KILL_PROCESS_FINISH = "com.book.aciton.KILL_PROCESS_SUCCESS";

    /**
     * Broadcast intent fired on theme change.
     */
    public static final String ACTION_THEME_CHANGED = "com.book.intent.action.THEME_CHANGED";

    /**
     * Broadcast intent fired on theme change.
     */
    public static final String ACTION_THEME_DOWNLOADED = "com.book.intent.action.THEME_DOWNLOADED";

    /**
     * Similar to {@link Intent#ACTION_SET_WALLPAPER}.
     */
    public static final String ACTION_SET_THEME = "com.book.intent.action.SET_THEME";

    /**
     * For book Colorful View, wallpaper has changed
     */
    public static final String ACTION_COLORFUL_WALLPAPER_CHANGED = "com.book.intent.action.COLORFUL_WALLPAPER_CHANGED";
     ...
     */
    public static final String EXTRA_THEME_EXISTING_URI = "com.book.intent.extra.theme.EXISTING_URI";

    /**
     * URI for the profile in which the current theme is associated. If null, we will apply against the
     * currently applied profile.
     */
    public static final String EXTRA_THEME_PROFILE_URI = "com.book.intent.extra.theme.THEME_PROFILE_URI";
     ...
     */
    public static final String EXTRA_EXTENDED_THEME_CHANGE = "com.book.intent.extra.theme.EXTENDED_THEME_CHANGE";

    public static final String EXTRA_INCALLSTYLE_URI = "com.book.intent.extra.theme.INCALLSTYLE_URI";

    public static final String EXTRA_WALLPAPER_URI = "com.book.intent.extra.theme.WALLPAPER_URI";
    public static final String EXTRA_DONT_SET_LOCK_WALLPAPER = "com.book.intent.extra.theme.DONT_SET_LOCK_WALLPAPER";
    public static final String EXTRA_LOCK_WALLPAPER_URI = "com.book.intent.extra.theme.LOCK_WALLPAPER_URI";
    public static final String EXTRA_LIVE_WALLPAPER_COMPONENT = "com.book.intent.extra.theme.LIVE_WALLPAPER_COMPONENT";
    public static final String EXTRA_RINGTONE_URI = "com.book.intent.extra.theme.RINGTONE_URI";
    public static final String EXTRA_NOTIFICATION_RINGTONE_URI = "com.book.intent.extra.theme.NOTIFICATION_RINGTONE_URI";

    public static final String EXTRA_LOCKSCREEN_URI = "com.book.intent.extra.theme.LOCKSCREEN_URI";
    public static final String EXTRA_BOOT_ANIMATION_URI = "com.book.intent.extra.theme.BOOT_ANIMATION_URI";
    public static final String EXTRA_FONT_URI = "com.book.intent.extra.theme.FONT_URI";
    public static final String EXTRA_ICONS_URI = "com.book.intent.extra.theme.ICONS_URI";
    ...
    public static final Uri SILENT_RINGTONE_URI = Uri
            .parse("content://com.book.thememanager/ringtone/silent");

    public static final String START_FILEMANAGER_ACTION = "com.book.filemgr.path_start";

    public static final String THEME_LOCKSCREEN_PACKAGE = "com.book.lockscreen";

    public static final String THEME_LOCKSCREEN2_PACKAGE = "com.book.lockscreen2";

    public static final String SETTINGS_LOCKSCREEN = "book.theme.lockscreen";
    ...
    public static final String THEME_SERVICE_ACTION = "com.book.themes.ThemeService";

    public static final String ACTION_SERVICE_CREATED = "com.book.intent.action.SERVICE_CREATE";

    public static final String EXTRA_ICON_CHANGED = "com.book.intent.extra.theme.ICON_CHANGED";
    ...
    public Drawable loadIcon(ApplicationInfo ai) {
        ...
        try {
            ...
            if (d == null) {
                ...
                if (d == null && ai.icon == 0) {
                    d = getDrawableFromStaticCache("book.png");
                }
                if (d == null) {
    ...
    public Drawable loadIcon(PackageItemInfo pi) {
        ...
        return getDrawableFromStaticCache("book.png");
    }
    ...
    private Context getThemeChooserContext() {
        if (mThemeContext == null) {
            try {
                mThemeContext = mContext.createPackageContext("com.book.themechooser",
    ...
    class ThemeConnection implements ServiceConnection {
        ...
        private String PACKAGE_NAME = "com.book.thememanager";
        private String CLASS_NAME = "com.book.themes.service.ThemeService";
