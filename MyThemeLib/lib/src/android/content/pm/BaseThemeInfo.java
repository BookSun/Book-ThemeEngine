...
public class BaseThemeInfo implements Parcelable {
    ...
    public int lockscreenWallpaperResourceId;
    ...
    public String bootAnimationName;
    public String fontName;
    public String lockscreenName;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(lockscreenWallpaperResourceId);
        ...
        dest.writeString(bootAnimationName);
        dest.writeString(fontName);
        dest.writeString(lockscreenName);
        dest.writeString(iconsName);
        dest.writeInt(hasRedirection ? 1 : 0);
    }
    ...
    protected BaseThemeInfo(Parcel source) {
        ...
        lockscreenWallpaperResourceId = source.readInt();
        ...
        bootAnimationName = source.readString();
        fontName = source.readString();
        lockscreenName = source.readString();
        iconsName = source.readString();
        hasRedirection = (source.readInt() != 0);
    }
