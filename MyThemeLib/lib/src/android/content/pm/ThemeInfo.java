...
public final class ThemeInfo extends BaseThemeInfo {
    private enum AttributeIndex {
        ...
        STYLE_INDEX,
        BOOT_ANIMATION_INDEX,
        FONT_INDEX,
        LOCKSCREEN_INDEX,
        ICONS_INDEX,
        HAS_REDIRECTION_INDEX;
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
            ...
            if (tempMap.containsKey(key)) {
                ...
                switch (index) {
                    ...
                    case LOCKSCREEN_WALLPAPER_INDEX:
                        lockscreenWallpaperResourceId = attrs.getAttributeResourceValue(i, 0);
                        break;
                    ...
                    case BOOT_ANIMATION_INDEX:
                        bootAnimationName = attrs.getAttributeValue(i);
                        break;

                    case FONT_INDEX:
                        fontName = attrs.getAttributeValue(i);
                        break;

                    case LOCKSCREEN_INDEX:
                        lockscreenName = attrs.getAttributeValue(i);
                        break;

                    case ICONS_INDEX:
                        iconsName = attrs.getAttributeValue(i);
                        break;

                    case HAS_REDIRECTION_INDEX:
                        hasRedirection = attrs.getAttributeBooleanValue(i, false);
                        break;
                }
            }
        }
