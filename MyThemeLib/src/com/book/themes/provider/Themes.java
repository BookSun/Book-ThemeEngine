package com.book.themes.provider;
...
public class Themes {
    ...
    public static Uri getThemesUri(Context context, String[] themeIds) {
        ...
        return ThemeColumns.CONTENT_URI.buildUpon().appendPath("WOODY@book")
    ...
    public static boolean isThemePackage(final PackageInfo pi) {
        ...
        for (FeatureInfo fi : pi.reqFeatures) {
            ...
            if (fi.name.equals("com.book.software.themes")) {
                return true;
            }
        }
    ...
    private static void applyTheme(Context context, Intent intent) {
     ...
     // Begin, added by yljiang@booktek.com 2013-11-26 
...
//                        c.getString(0));
    ...
    public interface ThemeColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.book.cursor.dir/theme";
        public static final String CONTENT_ITEM_TYPE = "vnd.book.cursor.item/theme";

        public static final String STYLE_CONTENT_TYPE = "vnd.book.cursor.dir/style";
        public static final String STYLE_CONTENT_ITEM_TYPE = "vnd.book.cursor.item/style";
