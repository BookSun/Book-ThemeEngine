...
public class ThemeItem extends AbstractDAOItem {
 ...
 // End
    ...
    public Uri getThumbnails(Context context, PreviewsType type) {
        ...
        if(pkgName.startsWith("com.book.font.inner.")){
    ...
    // content://PackageResources.AUTHORITY/com.book.theme.Dream/assets/preview/preview-2.png
    /**
...
//    }
     ...
     */
    // Begin, added by yljiang@booktek.com 2013-11-29
